	...
	<div class="body_box">
			...
			<div class="titlebox" align="center">
				<c:choose>
					...
					<c:when test="${brd_type == 4 }"><h2>스터디&소모임 게시판</h2></c:when>
		   ...
		   <nav aria-label="Page navigation example">
				  <ul class="pagination pagination-lg justify-content-center">
					  <c:if test="${page.startPage > page.pageBlock }">
					  	<li class="page-item"><a class="page-link" href="/board/checkList?currentPage=${page.startPage-page.pageBlock}&brd_type=${brd_type}">이전</a></li>
					  </c:if>
					  <c:forEach var="i" begin="${page.startPage}" end="${page.endPage}">
				    	<li class="page-item"><a class="page-link" href="/board/checkList?currentPage=${i }&brd_type=${brd_type}">${i }</a></li>
				    	
				      </c:forEach>
				  	  <c:if test="${page.endPage<page.totalPage }">
				   		 <li class="page-item"><a class="page-link" href="/board/checkList?currentPage=${page.startPage+page.pageBlock }&brd_type=${brd_type}">다음</a></li>
